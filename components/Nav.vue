<template>
        ...
        <li><NuxtLink to="/services"><span class="icon">
          ...
          </span><span class="menu"><span>Services</span></span></NuxtLink></li>
        ...
        <li><NuxtLink to="/donations"><span class="icon">
          ...
          </span><span class="menu">Donations</span></NuxtLink></li>
      </ul>
